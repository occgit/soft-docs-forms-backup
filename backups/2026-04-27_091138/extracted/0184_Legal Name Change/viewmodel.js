define(['jquery',
    ...
    */
    ...
    vm.setDefaults = function setDefaults(source, inputValues) {
        ...
        if (pkg.isAtStep('SSStaff')) {
            vm.approvedBy(user.DisplayName);

            $("#firstName").prop("readonly", true);
            $("#middlaName").prop("readonly", true);
            $("#lastName").prop("readonly", true);
            $("#updateUsernameEmail").prop("disabled", true);
        ...
        if (user.isInLibrary) {
            ...
            vm.ssDocType('Legal Name Change');
    ...
    vm.afterRequired = function afterRequired(form) {
        ...
        if (form.attachmentCount < 1) {
            notify('error', 'You must attach a copy of your drivers license, Social Security Card, or court document for verification before submitting this form.');
            return false;
        } else {
            return true;
        }
