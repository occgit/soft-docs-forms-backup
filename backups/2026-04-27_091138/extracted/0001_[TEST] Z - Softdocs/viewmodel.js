    ...
    */
    ...
    vm.setDefaults = function setDefaults(source, inputValues) {
        ...
        vm.email.subscribe(function(emailSelected){
            ...
            integration.all("Web_Ethos_Person_Search", { nameType: "lastName", nameSearch:result}).then(function(data){ 
                console.log("Search data", data);
            
               const filtered = data.filter(person => person.emails && person.emails[0] && person.emails[0].address === emailSelected );
               console.log("FOUND PERSON:", filtered);
               let pGUID = filtered[0].id;
               console.log("P GUID", pGUID)
     
                 // "6639d624-c71c-4c24-8f9a-74a7169967ff"
                integration.first("Web_Ethos_Get_Person_by_GUID", { personGUID: "6639d624-c71c-4c24-8f9a-74a7169967ff"}).then(data => console.log("Person by GUID", data))
        ...
        integration.first("Web_Ethos_Get_Address_By_Address_GUId", { addressGUID: "d5683d52-df46-4d58-976d-99581f816edd"}).then(data => console.log("Addr by GUID data", data))
           ...
           if(vm.vendorSearch() && vm.vendorSearch() !== '') {
            ...
            // vm.zip('');
                ...
                Promise.all(promiseArrays).then(function (allMyPromisesReturned) {
                    ...
                    console.log('Web_Ethos_Get_Educational_Institutions_by_ColleagueID',allMyPromisesReturned[2]);
