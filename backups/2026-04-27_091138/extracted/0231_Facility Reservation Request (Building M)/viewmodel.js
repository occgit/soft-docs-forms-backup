define(['jquery',
    ...
    */
    ...
    function makeAllFieldsReadOnly() {
        ...
        $("#federalID").prop("readonly", true);
        $("#organizationAddress").prop("readonly", true);
        $("#organizationCity").prop("readonly", true);
        $("#organizationState").prop("readonly", true);
        $("#organizationZip").prop("readonly", true);
        $("#organizationContactName").prop("readonly", true);
        $("#organizationContactEmail").prop("readonly", true);
        $("#organizationContactPhone").prop("readonly", true);
        $("#instructorName").prop("readonly", true);
        $("#instructorPhone").prop("readonly", true);
        $("#software").prop("readonly", true);
        $("#purposeOfEvent").prop("readonly", true);
        $("#expectedAttendance").prop("readonly", true);
        $("#eventDate").prop("readonly", true);
        $("#eventTime").prop("readonly", true);
        $("#arrivalTime").prop("readonly", true);
        $("#departTime").prop("readonly", true);
        $("#purposeOfEvent").prop("readonly", true);
        $("#partyDescription").prop("readonly", true);
        $("#neededEasels").prop("readonly", true);
    ...
    vm.onSubmit = function onSubmit(form) {
        ...
        if (!$('#classroomLayout').is(':checked') && !$('#podLayout').is(':checked') && !$('#uShaped').is(':checked') && !$('#openSquare').is(':checked')) {
            notify('error', 'Please select at least one desired layout of the room.');
            return false;
        }

        if (!$('#monday').is(':checked') && !$('#tuesday').is(':checked') && !$('#wednesday').is(':checked') && !$('#thursday').is(':checked') && !$('#friday').is(':checked') && !$('#saturday').is(':checked')) {
            notify('error', 'Please select at least one day that the facility is needed.');
            return false;
        }
