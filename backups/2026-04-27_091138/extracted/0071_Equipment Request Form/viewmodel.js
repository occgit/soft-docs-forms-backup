    ...
    */
	...
	vm.afterLoad = function afterLoad() {
		...
		ko.computed(function () {
			...
			if (
				vm.checkOutEquipment() == true ||
				vm.checkInEquipment() == true
			) {
				...
				if (vm.checkOutEquipment() == true) {
					...
					vm.equipmentCheckOutRow().forEach(
				...
				if (vm.checkInEquipment() == true) {
					...
					vm.equipmentCheckInRow().forEach(
		...
		vm.isSamePerson = ko.computed(function () {
			...
			console.log("Is the same person?", isSamePerson);
			return isSamePerson;
		});
