define(['jquery',
...
], function viewmodel($, ko, vm, integration, notify, user, autosize, maskedinput, liveVM) {
    ...
    */
    ...
    vm.setDefaults = function setDefaults(source, inputValues) {
        ...
        integration.all('Get_Source_Test',{
        // 	Parameter1: 'data',
        // 	Parameter2: vm.FieldIDOnForm()
        }).then(function (ReturnedDataFromSource) {
        	console.log(ReturnedDataFromSource);
        });
