    ...
    vm.tables = [
        {
            ...
            integrationCodes: {
                GetAll:     'MileageRates',
                UpdateFld:  'MileageRates',
                DeleteRow:  'MileageRates',
                AddRow:     'MileageRates',
                Truncate:   'MileageRates_Truncate'
            },
            data: mileageRatesDataFields
        },
        {
            name: 'Standard Mileage',
            integrationCodes: {
                GetAll:     'StandardMileage',
                UpdateFld:  'StandardMileage',
                DeleteRow:  'StandardMileage',
                AddRow:     'StandardMileage',
                Truncate:   'StandardMileage_Truncate'
            },
            data: standardMileageDataFields
        },
        {
            name: 'Meals Per Diem',
            integrationCodes: {
                ...
                DeleteRow:  'PerDiem',
                AddRow:     'PerDiem',
                Truncate:   'PerDiem_Truncate'
            },
            data: perDiemDataFields
        }
    ];
