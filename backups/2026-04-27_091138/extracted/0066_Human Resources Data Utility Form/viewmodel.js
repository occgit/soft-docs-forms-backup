define([
    ...
    */
    ...
    vm.tables = [
        {
            name: 'HR Departments Data',
            integrationCodes: {
                GetAll:     'HRDepartments',
                UpdateFld:  'HRDepartments',
                DeleteRow:  'HRDepartments',
                AddRow:     'HRDepartments',
                Truncate:   'HRDepartments_Truncate'
            },
            data: hrDepartmentDataFields
        },
        {
            name: 'HR Routing Data',
            integrationCodes: {
                GetAll:     'HR_Routing_Data',
                UpdateFld:  'HR_Routing_Data',
                DeleteRow:  'HR_Routing_Data',
                AddRow:     'HR_Routing_Data',
                Truncate:   'HR_Routing_Data_Truncate'
            },
            data: hrRoutingData
        },
    ...
    // Run drawTable only when a table is selected
    vm.table.subscribe(function (table) {
        ...
        // Only draw if the user actually picked a table
        if (table) {
            drawTable();
        }
    });
