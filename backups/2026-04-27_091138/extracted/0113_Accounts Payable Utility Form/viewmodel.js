define([
    ...
    */
    ...
    var apDeptApproversDataFields = [
        ...
        {
            id: 'Approver1UserID',
            name: 'Approver 1 User ID',
            field: 'Approver1UserID',
            width: 300,
            editor: Slick.Editors.Text,
            sortable: true
        },
        ...
        {
            id: 'Approver2UserID',
            name: 'Approver 2 User ID',
            field: 'Approver2UserID',
            width: 300,
            editor: Slick.Editors.Text,
            sortable: true
        },
        ...
        {
            id: 'Approver3UserID',
            name: 'Approver 3 User ID',
            field: 'Approver3UserID',
            width: 300,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'Approver3Email',
            name: 'Approver 3 Email',
            field: 'Approver3Email',
            width: 300,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'Approver4UserID',
            name: 'Approver 4 User ID',
            field: 'Approver4UserID',
            width: 300,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'Approver4Email',
            name: 'Approver 4 Email',
            field: 'Approver4Email',
            width: 300,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'Approver5UserID',
            name: 'Approver 5 User ID',
            field: 'Approver5UserID',
            width: 300,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'Approver5Email',
            name: 'Approver 5 Email',
            field: 'Approver5Email',
            width: 300,
            editor: Slick.Editors.Text,
            sortable: true
        },
    ...
    vm.tables = [
        {
            name: 'AP Department Approvers',
            integrationCodes: {
                GetAll:     'APDepartmentApprovers',
                UpdateFld:  'APDepartmentApprovers',
                DeleteRow:  'APDepartmentApprovers',
                AddRow:     'APDepartmentApprovers',
                Truncate:   'APDepartmentApprovers_Truncate'
            },
            data: apDeptApproversDataFields
        },
    ];
