	...
	vm.setDefaults = function setDefaults(source, inputValues) {
										...
										if (isCurrentTerm) {
											vm.studentCourseReg.push({
												...
												registrationInstructorName:
													instructorName,
												registrationCourseTitle:
													courseTitle,
												registrationDeadlineDate:
													censusDate //censusDate + 7 days
											});
										} //end isCurrentTerm
									}
								}
		...
		vm.courseSection.subscribe(function (sig) {
			...
			integration
				...
				.then(function (val) {
					...
					console.log(val.Dean_Email, val.Dean);
				});
		});
		...
		vm.deadlineDate.subscribe(function (deadlineDt) {
			...
			if (currentDate < deadlineDate) {
				...
				notify(
					"error",
					"This deadline date has passed for this course."
				);
