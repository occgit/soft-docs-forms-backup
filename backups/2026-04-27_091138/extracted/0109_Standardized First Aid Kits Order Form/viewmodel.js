define([
	...
	const GROUP = {
		AHPublicSafety: "b8eba5a3-793c-46ac-ab5e-1c72e1b233c8",
		HLPublicSafety: "2e64c168-a5a8-4678-aede-b0470a9138e2",
		ORPublicSafety: "462189f1-58b9-40e9-b68c-da2ded2e4f7f",
		ROPublicSafety: "3f75ac03-361c-44fa-b63f-e3b2479e49a5",
		SFPublicSafety: "c1fc9b0e-f0e2-4f53-8919-6f0d200122f6"
	};
    ...
    */
	...
	// vm.addObservableArray('itemDescription');
	// vm.addObservableArray('itemList');
	...
	vm.setDefaults = function setDefaults(source, inputValues) {
		...
		vm.campus.subscribe(function (newValue) {
			switch (newValue) {
				case "Auburn Hills":
					vm.groupPrincipalID(GROUP.AHPublicSafety);
					vm.publicSafetyEmail("AHPubSfy@oaklandcc.edu");
					break;
				case "Highland Lakes":
					vm.groupPrincipalID(GROUP.HLPublicSafety);
					vm.publicSafetyEmail("HLPubSfy@oakandcc.edu");
					break;
				case "Orchard Ridge":
					vm.groupPrincipalID(GROUP.ORPublicSafety);
					vm.publicSafetyEmail("ORPubSfy@oaklandcc.edu");
					break;
				case "Royal Oak":
					vm.groupPrincipalID(GROUP.ROPublicSafety);
					vm.publicSafetyEmail("ROPubSfy@oaklandcc.edu");
					break;
				case "Southfield":
					vm.groupPrincipalID(GROUP.SFPublicSafety);
					vm.publicSafetyEmail("SFPubSfy@oaklandcc.edu");
					break;
				default:
					vm.groupPrincipalID("");
					break;
	...
	vm.afterRequired = function afterRequired(form) {
		...
		if (pkg.isAtStep("ConditionalCampus")) {
			let promise = new Promise(function (resolve, reject) {
				vm.itemList.forEach((itemRow) => {
					integration.add("Add_First_Aid_Request", {
						RequestDate: vm.originationDate(),
						Campus: vm.campus(),
						Requester: vm.originatorDisplayName(),
