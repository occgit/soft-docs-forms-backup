        ...
        */
		...
		if (user.isInLibrary) {
			...
			integration
				...
				.catch(function (err) {
					console.error(
						"HR_Get_Career_Progress_Check_In_Info failed",
						err
					);
					notify(
						"error",
						...
						.then(function (cpData) {
							if (cpData.length > 0) {
								...
								if (cpData[0].CheckInNumber == "Complete") {
									...
									// $("#jobTitle").prop("readonly", false);
									$("#personalGoals").prop("readonly", true);
									$("#departmentGoals").prop(
										"readonly",
										true
									);
									$("#collegewideGoals").prop(
										"readonly",
										true
									);
									$("#empFeedbackCheckIn1").prop(
										"readonly",
										true
									);
									$("#additionalCommentsCheckIn1").prop(
										"readonly",
										true
									);
									vm.personalGoals(
										cpData[0].PersonalGoalsCheckIn1
									);
									vm.departmentGoals(
										cpData[0].DepartmentGoalsCheckIn1
									);
									vm.collegewideGoals(
										cpData[0].CollegeWideGoalsCheckIn1
									);
									vm.empFeedbackCheckIn1(
										cpData[0].EmpFeedbackCheckIn1
									);
									vm.additionalCommentsCheckIn1(
										cpData[0].AddCommentsCheckIn1
									);
									...
									//make 2nd check in inputs read only
									$("#keyAccompCheckin2").prop(
										"readonly",
										true
									);
									$("#opportunitiesCheckIn2").prop(
										"readonly",
										true
									);
									$("#supportiveMeasuresCheckIn2").prop(
										"readonly",
										true
									);
									$("#empFeedbackCheckIn2").prop(
										"readonly",
										true
									);
									$("#additionalCommentsCheckIn2").prop(
										"readonly",
										true
									);
									//add data to 2nd check in inputs
									vm.keyAccompCheckin2(
										cpData[0].KeyAccompCheckIn2
									);
									vm.opportunitiesCheckIn2(
										cpData[0].OppCheckIn2
									);
									vm.supportiveMeasuresCheckIn2(
										cpData[0].SupMeasuresCheckIn2
									);
									vm.empFeedbackCheckIn2(
										cpData[0].EmpFeedbackCheckIn2
									);
									vm.additionalCommentsCheckIn2(
										cpData[0].AddCommentsCheckIn2
									);
