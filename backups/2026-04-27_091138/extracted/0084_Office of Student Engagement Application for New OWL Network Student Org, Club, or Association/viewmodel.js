    ...
    */
	...
	vm.afterRequired = function afterRequired(form) {
		...
		if (pkg.isAtStep("WFRSOStudentEngagementCoordinators")) {
			...
			console.info(
				"Is there additional advisors?",
				isThereAdditionalAdvisor
			);
						...
						integration
							.add("Add_RSO_Info", {
								...
								advisor:
									advisorVals.additionalAdvisorNameHidden(),
								advisorPhone:
									advisorVals.additionalAdvisorPhone() || "",
								advisorEmail:
									advisorVals.additionalAdvisorEmail()
							})
							.catch(function (error) {
								console.error(
									"Error adding additional Advisor: ",
									error
								);
							})
					);
