define([
		...
		integration
			...
			.then(function (employeeInfo) {
				if (employeeInfo) {
					...
					notify("error", "No data found for this employee id.");
				}
			});
	});
    ...
    */
	...
	vm.setDefaults = function setDefaults(source, inputValues) {
		...
		if (pkg.isAtStep("HRWFFullTimeReviewers") || pkg.isAtStep("End")) {
			$(".humanResources").show();
		}

		if (pkg.isAtStep("HRWFPayroll") || pkg.isAtStep("End")) {
			$(".payroll").show();
		}
