    ...
    */
            ...
            if (vm.studentID().length == 7) { // check if there's 7 digits
                ...
                integration.first('Web_Ethos_Get_Persons_by_Colleague_ID', { personID: vm.studentID() }).then(function (personResults) {
                    ...
                    if (personResults) {
                        ...
                        integration.all('Web_Ethos_Get_Active_Programs_by_Colleague_ID', { studentID: vm.studentID() }).then(function (programInfo) {
    ...
    vm.setDefaults = function setDefaults(source, inputValues) {
        ...
        vm.selectedTerm.subscribe((newValue) => {
            ...
            integration.all('Web_Ethos_Section_Registration_by_Registrant', { personGUID: vm.personGUID() }).then(function (registration) {
