define(['jquery',
    ...
    */
    ...
    function makeAllFieldsReadOnly() {
        ...
        makeAutoCompleteReadOnly('startTime');
        makeAutoCompleteReadOnly('endTime');
        $("#numberOfWeeks").prop("readonly", true);
        $("#currentRoom").prop("readonly", true);
        $("#requestedRoom").prop("readonly", true);
    ...
    vm.onSubmit = function onSubmit(form) {
        ...
        if (!$('#monday').is(':checked') && !$('#tuesday').is(':checked') && !$('#wednesday').is(':checked') && !$('#thursday').is(':checked') && !$('#friday').is(':checked')
            && !$('#saturday').is(':checked') && !$('#sunday').is(':checked')) {
