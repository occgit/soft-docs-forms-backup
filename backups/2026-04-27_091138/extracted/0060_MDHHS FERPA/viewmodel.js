    ...
    */
    ...
    vm.setDefaults = function setDefaults(source, inputValues) {
        ...
        if (user.isInLibrary) {
            ...
            integration.first('EthosColleagueStudentByErpId', {
            }).then(function(studentInfo){
                console.log('Student Info: ', studentInfo);
                vm.studentFirstName(studentInfo.names[0].firstName);
                vm.studentLastName(studentInfo.names[0].lastName);
                if (studentInfo.names[0].middleName) {
                    vm.studentMiddleInitial(studentInfo.names[0].middleName[0] + '.');
                } else {
                    vm.studentMiddleInitial('N/A');
                }
            });
        } else {
