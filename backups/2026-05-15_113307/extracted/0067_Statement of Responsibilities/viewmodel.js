define([
  ...
  vm.setDefaults = function setDefaults(source, inputValues) {
    ...
    if (user.isInLibrary) {
      ...
      vm.vaDocType("Statement of Responsibilities");
  ...
  function getAcademicYear() {
    ...
    const academicYearStartMonth = 8; // September (months are zero-indexed, so September is 8)
    const academicYearEndMonth = 7; // August (months are zero-indexed, so August is 7)
