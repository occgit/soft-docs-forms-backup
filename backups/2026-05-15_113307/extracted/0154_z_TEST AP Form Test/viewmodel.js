...
// }
    ...
    */
    ...
    vm.setDefaults = function setDefaults(source, inputValues) {
        ...
        // integration.all('Web_Ethos_Get_Invoice_Information', {
            
        // }).then(invoiceInfo => {
        //     console.log('Invoice Info: ', invoiceInfo);
        // });

        integration.all('Web_Ethos_Get_Invoice_Information_by_Invoice_GUID', {
            invoiceGUID: '3cfc69df-8b12-44d4-b3ca-5d95ac639b0f'
        }).then(invoiceInfo => {
            console.log('Invoice Info: ', invoiceInfo);
        });

        // getAllDataFromPagingSource('Web_Ethos_Get_Invoice_Information',100).then(listOfAssetData => {
