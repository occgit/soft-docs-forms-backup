define([
  ...
  vm.afterLoad = function afterLoad() {
    ...
    ko.computed(function () {
      ...
      if (vm.englishComposition()) checkedCount++;
      ...
      if (vm.communications()) checkedCount++;

      // Require at least one checkbox to be checked
      if (checkedCount === 0) {
        // Set all checkboxes to required
        requiredIndicators.setRequired("englishComposition", true);
        requiredIndicators.setRequired("mathOrScience", true);
        requiredIndicators.setRequired("socialScience", true);
        requiredIndicators.setRequired("fineArtsOrHumanities", true);
        requiredIndicators.setRequired("writtenCommunication", true);
        requiredIndicators.setRequired("communications", true);
      } else {
        // At least one checkbox is checked, so set all checkboxes to not required
        requiredIndicators.setRequired("englishComposition", false);
        requiredIndicators.setRequired("mathOrScience", false);
        requiredIndicators.setRequired("socialScience", false);
        requiredIndicators.setRequired("fineArtsOrHumanities", false);
        requiredIndicators.setRequired("writtenCommunication", false);
        requiredIndicators.setRequired("communications", false);
      }
    });
    ...
    ko.computed(function () {
      ...
      if (vm.englishComposition()) checkedCountTwo++;
      ...
      if (vm.communications()) checkedCountTwo++;
