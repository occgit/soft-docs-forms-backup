define([
  ...
  $(".developer").hide();
  //Hide the Reason for Decline Section
  $(".declineHide").hide();
  ...
  vm.setDefaults = function setDefaults(source, inputValues) {
    ...
    if (pkg.isAtStep("ConditionalOriginator")) {
      $(".declineHide").show();
    }
  ...
  vm.afterRequired = function afterRequired(form) {
    ...
    //   notify('error','You must attach a copy of your Social Security Card before submitting this form.');
    //   return false;
    // }else{
    //   return true;
    // }
