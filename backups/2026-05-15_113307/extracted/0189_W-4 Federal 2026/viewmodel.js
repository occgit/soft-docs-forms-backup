define([
    ...
    *********************************************/
    function validateSignature(sig){
        var fullName = vm.originatorFirstName() +" "+vm.originatorLastName();
    ...
    vm.setDefaults = function setDefaults(source, inputValues){
        ...
        if(pkg.isAtStep('Start')){
            integration.all('EthosColleagueEmployeeByErpId', {}).then(function(data){
                // console.log("Data From Ethos:", data[0]);
                let employeeInfo = data[0];
                let employeeFirstName = employeeInfo.names[0].firstName;
                let employeeLastName = employeeInfo.names[0].lastName;
                
                console.log("First Legal Name:", employeeFirstName)
                console.log("Last Legal Name:", employeeLastName)
                
                vm.employeeFirstName(employeeFirstName);
                vm.employeeLastName(employeeLastName);
