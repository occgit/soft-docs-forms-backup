...
define([
	...
	/*
	   ...
	   1/14/26   EHP   Added originatorErpId field to the pdf
	...
	*/
    ...
    vm.setDefaults = function setDefaults(source, inputValues){
        ...
        vm['employers name']('Oakland Community College');
        vm['Federal Employer Identification Number']('38-1751522');
        vm['address of employer']('2900 Featherstone Rd');
        vm['city or town of employer']('Auburn Hills');
        vm['State of employer']('MI');
        vm['zip code of employer']('48326-2845');
        vm['name of contact person']('Elizabeth Gross');
        vm['contact phone number']('(248) 341-2170');
        
        vm['employers name'].readOnly = true;
        vm['Federal Employer Identification Number'].readOnly = true;
        vm['address of employer'].readOnly = true;
        vm['city or town of employer'].readOnly = true;
        vm['State of employer'].readOnly = true;
        vm['zip code of employer'].readOnly = true;
        vm['name of contact person'].readOnly = true;
        vm['contact phone number'].readOnly = true;
        
        
        const $field = $("[name='originatorErpId']");
