...
define([
    ...
    var tableShow = ['AP Secure - W9s', 'AP Secure - Vendor Direct Deposits'];     //list to expand, remove to collapse
    var displayTable = [];
    ...
    $('#refreshBtn').click(function () {
        ...
        integration.all('Dashboard_AP_Secure', {}).then(function (contentData) {
    ...
    function splitAndDraw(documents) {
        ...
        //-------------------------------Adjust this forEach section below if you have multiple lanes for your Dashboard--------------------------------        
        documents.forEach(function (doc, index) {
            ...
            documentConfig.forEach(function (configObj) {
                ...
                if (configObj.docTypeArray.includes(doc.DocumentType) === true) {
                    if (configObj.title === 'AP Secure - W9s') {
                        configObj.documents.push(doc);
                    }
                    else if (configObj.title === 'AP Secure - Vendor Direct Deposits') {
                        configObj.documents.push(doc);
                    }
                }
