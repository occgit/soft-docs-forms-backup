...
define([
    ...
    vm.onLoad = function onLoad(source, inputValues){
        ...
        $('#nameOfCollege').attr('readonly',true);
        $('#Attention').attr('readonly',true);
        $('#Address').attr('readonly',true);
        $('#City').attr('readonly',true);
        $('#State').attr('readonly',true);
        $('#Zip').attr('readonly',true);
        $('#originatorDisplayName').attr('readonly',true);
    ...
    vm.setDefaults = function setDefaults(source, inputValues){
        ...
        //  may not be saved to the server.
         ...
         $('#collegeAddress, #homeAddress, #City_2, #athleteSport, #DateofBirth, #AC, #cellNumber, #AC2, #Phone, #State_2, #Zip_2').prop('required', 'true');
         
             $('#DateofBirth').mask("99/99/9999");
			 $('#fathersDOB').mask("99/99/9999");
			 $('#mothersDOB').mask("99/99/9999");
			 $('#cellNumber').mask("999-9999");
			 $('#Phone').mask("999-9999");
			 $('#fatherPhone').mask("999-9999");
			 $('#motherPhone').mask("999-9999");
			 $('#fatherInsPhone').mask("999-9999");
			 $('#motherInsPhone').mask("999-9999");
