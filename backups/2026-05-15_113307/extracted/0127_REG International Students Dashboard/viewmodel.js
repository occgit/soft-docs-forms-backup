...
define([
    ...
    var tableShow = ['International Student Documents'];
    var displayTable = [];
    ...
    function drawTable(config, index) {
       ...
       var $theader = $('<thead>');
        ...
        stats.studentCount = new Set(config.documents.map( doc => doc.studentNumber)).size;
    ...
    function buildFullStats(data) {
        ...
        stats.studentCount = new Set(data.map( doc => doc.studentNumber)).size;
