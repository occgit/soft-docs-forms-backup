...
define([
    ...
    vm.setDefaults = function setDefaults(source, inputValues){
        ...
        today = mm + '/' + dd + '/' + yyyy; 
        vm['Add the date'](today); 
        
        vm['Add the date'].readOnly = true;

        vm['enter full name'](user.DisplayName)    
        vm['enter full name'].readOnly = true   
        vm['enter employee ID number'](user.ErpId)    
        vm['enter employee ID number'].readOnly = true             
