define(['jquery',
    ...
    */
    ...
    if (pkg.isAtStep('WFHRFTReviewers') || pkg.isAtStep('ConditionalActorRouteSupervisorEmail') || pkg.isAtStep('End')) {
        $('.humanResources').show();
    }
    
    if (pkg.isAtStep('ConditionalActorRouteSupervisorEmail') || pkg.isAtStep('End')) {
        $('.supervisor').show();
    }
