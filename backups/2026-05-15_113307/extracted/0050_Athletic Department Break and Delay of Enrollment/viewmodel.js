...
define([
    ...
    vm.onLoad = function onLoad(source, inputValues){
        ...
        $('#originatorDisplayName').attr('readonly',true);
             ...
             // document.getElementById('originatorErpId').style.display = 'none';
         document.getElementById('originatorErpId').hidden = 'true';  
        // document.getElementById('InputHint').hidden = 'true';   
        
        // Get the element with the ID 'originatorErpId'
        let originatorElement = document.getElementById('originatorErpId');
       ...
       // document.getElementById('AcademicYear').style.display = 'none';
        ...
        let originatorElement2 = document.getElementById('AcademicYear');
        // Check if the element exists
        if (originatorElement2) {    
        // Traverse to the previous sibling element
        let previousElement = originatorElement2.previousElementSibling;
        // Loop to find the previous <div class="inputHint">
        while (previousElement) {        if (previousElement.classList.contains('inputHint')) {
        // Found the previous <div class="inputHint">
        previousElement.hidden = true; // Hide the element
    ...
    vm.setDefaults = function setDefaults(source, inputValues){
        ...
        //  may not be saved to the server.
          ...
          $('#collegeName, #sportsList, #Term, #scholarshipTerms, #athleteSignature, #signatureDate').prop('required', 'true');
