    ...
    */
    ...
    var academicRoutingDataFields = [
        ...
        },    
        {
            ...
            field: 'Administrative_Specialist',
            width: 200,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'Administrative_Specialist_Email',
            name: 'Administrative Specialist Email',
            field: 'Administrative_Specialist_Email',
            width: 200,
            editor: Slick.Editors.Text,
            sortable: true
        },        
        ...
        {
            id: 'Department_Chair_Email',
            name: 'Department Chair Email',
            field: 'Department_Chair_Email',
            width: 200,
            editor: Slick.Editors.Text,
            sortable: true
        },
    ...
    var academicTermsDataFields = [
        ...
        {
            id: 'TermActiveDate',
            name: 'Term Active Date (dd/mm/yyyy)',
            field: 'TermActiveDate',
            width: 275,
            editor: Slick.Editors.Text,
            sortable: true,
        }
    ...
    var programCoordinatorRoutingDataFields = [
        ...
        {
            id: 'Program_Coordinator_Name',
            name: 'Program Coordinator Name',
            field: 'Program_Coordinator_Name',
            width: 250,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'Program_Coordinator_Email',
            name: 'Program Coordinator Email',
            field: 'Program_Coordinator_Email',
            width: 250,
            editor: Slick.Editors.Text,
            sortable: true,
        },    
    ...
    var creditByExamOrPortfolioDataFields = [
        ...
        {
            id: 'CourseCreditEquiv',
            name: 'Course Equivalency',
            field: 'CourseCreditEquiv',
            width: 150,
            editor: Slick.Editors.Text,
            sortable: true,
        },    
        ...
        {
            id: 'AuburnTestingCenter',
            name: 'Auburn',
            field: 'AuburnTestingCenter',
            width: 200,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'OrchardTestingCenter',
            name: 'Orchard',
            field: 'OrchardTestingCenter',
            width: 200,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'ChairCoordinator',
            name: 'Chair/Coordinator',
            field: 'ChairCoordinator',
            width: 200,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'ChairCoordinatorEmail',
            name: 'Chair/Coordinator Email',
            field: 'ChairCoordinatorEmail',
            width: 200,
            editor: Slick.Editors.Text,
            sortable: true
        },
        ...
        {
            id: 'AdministrativeSpecialist',
            name: 'Administrative Specialist',
            field: 'AdministrativeSpecialist',
            width: 200,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'AdministrativeSpecialistEmail',
            name: 'Administrative Specialist Email',
            field: 'AdministrativeSpecialistEmail',
            width: 200,
            editor: Slick.Editors.Text,
            sortable: true
        }
    ...
    var nonTraditionalSubjectListDataFields = [
    ...
    var nonTraditionalInstructionalMethodListDataFields = [

        {
            id: 'InstructionalMethod',
            name: 'Instructional Method',
            field: 'InstructionalMethod',
            width: 250,
            editor: Slick.Editors.Text,
            sortable: true
        },
        {
            id: 'InstructionalMethodDesc',
            name: 'Instructional Method Desc',
            field: 'InstructionalMethodDesc',
            width: 250,
            editor: Slick.Editors.Text,
            sortable: true
        }
    ...
    vm.tables = [
        {
            name: 'Academics Routing Data',
            integrationCodes: {
                GetAll:     'AcademicRouting',
                UpdateFld:  'AcademicRouting',
                DeleteRow:  'AcademicRouting',
                AddRow:     'AcademicRouting',
                Truncate:   'AcademicRouting_Truncate'
            },
            data: academicRoutingDataFields
        },
        {
            name: 'Academics Terms with Active Date',
            integrationCodes: {
                GetAll:     'TermsChangeofSchedule',
                UpdateFld:  'TermsChangeofSchedule',
                DeleteRow:  'TermsChangeofSchedule',
                AddRow:     'TermsChangeofSchedule',
                Truncate:   'TermsChangeofSchedule_Truncate'
            },
            data: academicTermsDataFields
        },
        {
            name: 'Program Coordinator Routing Data',
            integrationCodes: {
                GetAll:     'ProgramCoordinatorRouting',
                UpdateFld:  'ProgramCoordinatorRouting',
                DeleteRow:  'ProgramCoordinatorRouting',
                AddRow:     'ProgramCoordinatorRouting',
                Truncate:   'ProgramCoordinatorRouting_Truncate'
            },
            data: programCoordinatorRoutingDataFields
        },
        {
            name: 'Credit by Exam or Portfolio Data',
            integrationCodes: {
                GetAll:     'CreditByExamOrPortfolio',
                UpdateFld:  'CreditByExamOrPortfolio',
                DeleteRow:  'CreditByExamOrPortfolio',
                AddRow:     'CreditByExamOrPortfolio',
                Truncate:   'CreditByExamOrPortfolio_Truncate'
            },
            data: creditByExamOrPortfolioDataFields
        },
        {
            name: 'Non-Traditional Subject List',
            integrationCodes: {
                GetAll:     'NonTraditionalSubjectList',
                UpdateFld:  'NonTraditionalSubjectList',
                DeleteRow:  'NonTraditionalSubjectList',
                AddRow:     'NonTraditionalSubjectList',
                Truncate:   'NonTraditionalSubjectList_Truncate'
            },
            data: nonTraditionalSubjectListDataFields
        },
        {
            name: 'Non-Traditional Instructional Method List',
            integrationCodes: {
                GetAll:     'NonTraditionalInstructionalMethodList',
                UpdateFld:  'NonTraditionalInstructionalMethodList',
                DeleteRow:  'NonTraditionalInstructionalMethodList',
                AddRow:     'NonTraditionalInstructionalMethodList',
                Truncate:   'NonTraditionalInstructionalMethodList_Truncate'
            },
            data: nonTraditionalInstructionalMethodListDataFields
        }        
