    ...
    */
    ...
    vm.setDefaults = function setDefaults(source, inputValues) {
        ...
        integration.all('Web_Ethos_Get_Academic_Periods', {
            ...
            const sortedTerms = termsData.slice().sort((a, b) => new Date(a.startOn) - new Date(b.startOn));
        ...
        if (pkg.isAtStep('WFHRFTReviewers') || pkg.isAtStep('HRWFFinancialServices') || pkg.isAtStep('End')) {
            $('.humanResources').show();                        
        }
