define([
    ...
    */
    ...
    var rsoDataFields = [
            {
            id: 'RSOName',
            name: 'RSO Name (Recognized Student Organization)',
            field: 'RSOName',
            width: 500,
    ...
    vm.tables = [
        {
            name: 'Recognized Student Organizations',
            integrationCodes: {
                GetAll:     'RecognizedStudentOrganizations',
                UpdateFld:  'RecognizedStudentOrganizations',
                DeleteRow:  'RecognizedStudentOrganizations',
                AddRow:     'RecognizedStudentOrganizations',
                Truncate:   'RecognizedStudentOrganizations_Truncate'
            },
            data: rsoDataFields
        }
    ];
    ...
    vm.downloadData = function (delimiter) {
        ...
        link.download = vm.table().name + '.csv';
